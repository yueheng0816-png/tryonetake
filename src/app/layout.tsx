...
export const metadata: Metadata = {
  ...
  title: {
    default: "TryOneTake — Professional AI Headshots That Actually Look Like You",
    template: "%s | TryOneTake",
  },
  description:
  ...
  authors: [{ name: "TryOneTake" }],
  creator: "TryOneTake",
  publisher: "TryOneTake",
  robots: {
    index: true,
    follow: true,
    googleBot: {

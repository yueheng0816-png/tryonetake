...
const rows = [
  { label: "Photos needed", onetake: "1 photo", traditional: "In-person shoot", otherAI: "12–20 photos" },
  { label: "Price", onetake: "$19", traditional: "$200–$500", otherAI: "$29–$75" },
  { label: "Turnaround", onetake: "< 5 minutes", traditional: "Days to weeks", otherAI: "30 min – 4 hours" },
  { label: "Looks like you?", onetake: Icon.Check, traditional: Icon.Check, otherAI: Icon.X },
  { label: "Background variety", onetake: "25+ styles", traditional: "Limited by studio", otherAI: "10–15 styles" },
  { label: "Retakes", onetake: "Instant regen", traditional: "Reschedule + fee", otherAI: "Usually limited" },
  { label: "Ready for LinkedIn", onetake: Icon.Check, traditional: Icon.Check, otherAI: "Sometimes" },
];
            ...
            <thead>
              <tr className="border-b border-border bg-muted/50">
                ...
                <th className="px-6 py-4 text-center font-semibold">
                  <span className="rounded-md bg-primary/10 px-3 py-1 text-primary">OneTake</span>
                </th>
